...
const uint8_t FirmwareID[32] __attribute__((aligned(32))) = { 'A', 'D', 'I', ' ', 'F', 'X', '3', ' ', 'R', 'E', 'V', ' ', '2', '.', '0', '.', '5', '-','P','U','B',' ', '\0' };
...
/**
  ...
  *
  * When the part first powers this function initializes the device, memory, and IO matrix, and then boots the RTOS kernel.
 **/
int main (void)
{
...
/**
  ...
  *
  * @param setupdat0 The first set of setup data
  *
  * @param setupdat1 The second set of setup data
  *
  * @return A boolean indicating if the control endpoint event was handled properly.
  *
 **/
...
/**
  ...
  *
  * At the moment this function handles errors by printing an error message to the UART console and
  * looping indefinitely. In the future it might be prudent to do something more intelligent here
  * based on the specific error condition.
  *
 **/
...
/**
  ...
  *
  * It configures all GPIO and timers used by the firmware, as well as the USB endpoints,
  * DMA controller, and SPI hardware.
 **/
