...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0x3E,                           /* Max power consumption of device (in 8mA unit) : 500mA */
    ...
    /* Endpoint descriptor for real time streaming endpoint */
    0x07,                           /* Descriptor size */
    ...
    /* Super speed endpoint companion descriptor for streaming endpoint */
    ...
    /* Super speed endpoint companion descriptor for data from pc endpoint */
    0x06,                           /* Descriptor size */
    CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
    0x00,                           /* Max no. of packets in a burst : 0: burst 1 packet at a time */
    0x00,                           /* Max streams for bulk EP = 0 (No streams) */
    ...
    /* Super speed endpoint companion descriptor for data to PC endpoint */
    0x06,                           /* Descriptor size */
    CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
    0x00,                           /* Max no. of packets in a burst : 0: burst 1 packet at a time */
    0x00,                           /* Max streams for bulk EP = 0 (No streams) */
...
const uint8_t CyFxUSBHSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0x00,                           /* COnfiguration string index */
    0x80,                           /* Config characteristics - bus powered */
    0x7D,                           /* Max power consumption of device (in 2mA unit) : 500mA */
