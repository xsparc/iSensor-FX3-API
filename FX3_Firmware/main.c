...
const uint8_t FirmwareID[32] __attribute__((aligned(32))) = "ADI FX3 REV 2.5.0-PUB\0";
...
/**
  ...
  * should be issued using a function call in the FX3API.
 **/
...
/**
  ...
  *
  * @returns The connected board type
  *
