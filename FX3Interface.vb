...
#Region "Interface Variable Initialization"
    ...
    Private Enum eventHandlerFlags As Integer
        m_handleDisconnect = 1
        m_handleConnect = 2
        m_disconnectHandled = 4
        m_connectHandled = 8
        m_programMode = 16
    End Enum
    ...
    Private usbList As USBDeviceList
...
#Region "Connection Functions"
    ...
    Public ReadOnly Property ActiveFX3SerialNumber As String
        Get
...
#Region "FX3 Board Management"
    ...
    Private Sub RefreshDeviceList()
        ...
        For Each item As USBDevice In usbList

            If m_FX3Connected Then
                If String.Equals(CType(item, CyFX3Device).FriendlyName, "Cypress FX3 USB BootLoader Device") Then
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub usbList_DeviceAttached(ByVal sender As Object, e As EventArgs)
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub usbList_DeviceRemoved(ByVal sender As Object, e As EventArgs)
    ...
    Public Sub ProgramSDRAM(ByVal FileName As String, boardId As CyFX3Device)
        ...
        Try
            flashSuccess = boardId.DownloadFw(FileName, FX3_FWDWNLOAD_MEDIA_TYPE.RAM)
    ...
    Private Sub WaitForFX3Reset()
        ...
        While (timer.ElapsedMilliseconds < 5000 And Not resetOk)
    ...
    Private Sub WaitForStreamer()
        ...
        While (timer.ElapsedMilliseconds < 5000 And Not streamerDetected)
            tempList = New USBDeviceList(CyConst.DEVICES_CYUSB)
            'Look for the device with a stock serial number
            For Each item In tempList
                'Look for the selected serial number, get its handle, and set it as the active device
